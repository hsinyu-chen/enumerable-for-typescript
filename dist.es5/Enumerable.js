define(["require", "exports", "tslib"], function (require, exports, tslib_1) {
    ...
    var Enumerable = /** @class */ (function () {
        ...
        Enumerable.prototype.select = function (selector) {
            var ref = this;
            return new Enumerable((function () {
                var e_9, _a, idx, ref_3, ref_3_1, item, e_9_1;
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            _b.label = 2;
                        case 2:
                            if (!!ref_3_1.done) return [3 /*break*/, 5];
                            item = ref_3_1.value;
        ...
        Enumerable.prototype.where = function (predicate) {
            var ref = this;
            return new Enumerable((function () {
                var e_11, _a, idx, ref_4, ref_4_1, item, e_11_1;
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            idx = 0;
                        ...
                        case 1:
                            ...
                            _b.label = 2;
                        case 2:
                            if (!!ref_4_1.done) return [3 /*break*/, 5];
                            item = ref_4_1.value;
        ...
        Enumerable.prototype.append = function (newItem) {
            var ref = this;
            return new Enumerable(function () {
                var e_14, _a, ref_5, ref_5_1, item, e_14_1;
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            _b.label = 1;
                        case 1:
                            if (!!ref_5_1.done) return [3 /*break*/, 4];
                            item = ref_5_1.value;
                            return [4 /*yield*/, item];
                        case 2:
                            _b.sent();
        ...
        Enumerable.prototype.concat = function (set) {
            var ref = this;
            return new Enumerable(function () {
                var e_15, _a, e_16, _b, ref_6, ref_6_1, item, e_15_1, _c, _d, item, e_16_1;
                return tslib_1.__generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            ...
                            _e.label = 1;
                        case 1:
                            if (!!ref_6_1.done) return [3 /*break*/, 4];
                            item = ref_6_1.value;
                            return [4 /*yield*/, item];
                        case 2:
                            _e.sent();
        ...
        Enumerable.prototype.defaultIfEmpty = function (defaultItem) {
            var ref = this;
            return new Enumerable(function () {
                var e_17, _a, hasItem, ref_7, ref_7_1, item, e_17_1;
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            hasItem = false;
        ...
        Enumerable.prototype.distinct = function (comparer) {
            ...
            var ref = this;
            return new Enumerable(function () {
                var e_18, _a, cache, _loop_1, ref_8, ref_8_1, item, e_18_1;
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            cache = [];
        ...
        Enumerable.prototype.except = function (set, comparer) {
            ...
            var ref = this;
            return new Enumerable(function () {
                var e_20, _a, e, ref_9, ref_9_1, item, e_20_1;
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            e = Enumerable.from(set);
        ...
        Enumerable.prototype.groupBy = function (keySelector, resultSelector, keyComparer) {
            ...
            var ref = this;
            return new Enumerable(function () {
                var e_21, _a, keyCache, _loop_2, ref_10, ref_10_1, item, e_21_1;
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            keyCache = [];
        ...
        Enumerable.prototype.groupJoin = function (set, letKeySelector, rightKeySelector, resultSelector, keyComparer) {
            ...
            var ref = this;
            return new Enumerable(function () {
                var e_22, _a, e, _loop_3, ref_11, ref_11_1, item, e_22_1;
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            e = Enumerable.from(set);
                        ...
                        case 1:
                            ...
                            _b.label = 2;
                        case 2:
                            if (!!ref_11_1.done) return [3 /*break*/, 5];
                            item = ref_11_1.value;
        ...
        Enumerable.prototype.intersect = function (set, comparer) {
            ...
            var ref = this;
            return new Enumerable(function () {
                var e_23, _a, e, ref_12, ref_12_1, item, e_23_1;
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            e = Enumerable.from(set);
                        ...
                        case 1:
                            _b.trys.push([1, 6, 7, 8]);
                            ref_12 = tslib_1.__values(ref), ref_12_1 = ref_12.next();
                            _b.label = 2;
                        case 2:
                            if (!!ref_12_1.done) return [3 /*break*/, 5];
                            item = ref_12_1.value;
                            if (!e.contains(item, comparer)) return [3 /*break*/, 4];
                            return [4 /*yield*/, item];
                        case 3:
        ...
        Enumerable.prototype.prepend = function (newItem) {
            var ref = this;
            return new Enumerable(function () {
                var e_25, _a, ref_13, ref_13_1, item, e_25_1;
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            _b.label = 3;
                        case 3:
                            if (!!ref_13_1.done) return [3 /*break*/, 6];
                            item = ref_13_1.value;
                            return [4 /*yield*/, item];
                        case 4:
                            _b.sent();
        ...
        Enumerable.prototype.reverse = function () {
            var ref = this;
            return new Enumerable(function () {
                var e_26, _a, cache, ref_14, ref_14_1, item, i;
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            cache = [];
                            try {
                                for (ref_14 = tslib_1.__values(ref), ref_14_1 = ref_14.next(); !ref_14_1.done; ref_14_1 = ref_14.next()) {
                                    item = ref_14_1.value;
                                    cache.push(item);
                                }
                            }
                ...
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            _b.label = 2;
                        case 2:
                            if (!!ref_15_1.done) return [3 /*break*/, 5];
                            item = ref_15_1.value;
                            if (c-- > 0) {
                                return [3 /*break*/, 4];
                            }
        ...
        Enumerable.prototype.skipWhile = function (predicate) {
            var ref = this;
            return new Enumerable((function () {
                var e_28, _a, skipping, idx, ref_16, ref_16_1, item, i, e_28_1;
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            skipping = true;
                        ...
                        case 1:
                            ...
                            _b.label = 2;
                        case 2:
                            if (!!ref_16_1.done) return [3 /*break*/, 8];
                            item = ref_16_1.value;
                            i = idx++;
        ...
        Enumerable.prototype.take = function (n) {
            var ref = this;
            return new Enumerable((function () {
                var e_29, _a, c, ref_17, ref_17_1, item, e_29_1;
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            c = n;
                        ...
                        case 1:
                            ...
                            ref_17 = tslib_1.__values(ref), ref_17_1 = ref_17.next();
                            _b.label = 2;
                        case 2:
                            if (!!ref_17_1.done) return [3 /*break*/, 6];
                            item = ref_17_1.value;
                        ...
                        case 8:
                            try {
                                if (ref_17_1 && !ref_17_1.done && (_a = ref_17.return)) _a.call(ref_17);
                            }
        ...
        Enumerable.prototype.takeWhile = function (predicate) {
            var ref = this;
            return new Enumerable((function () {
                var e_30, _a, ref_18, ref_18_1, item, e_30_1;
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 6, 7, 8]);
                            ref_18 = tslib_1.__values(ref), ref_18_1 = ref_18.next();
                            _b.label = 1;
                        case 1:
                            if (!!ref_18_1.done) return [3 /*break*/, 5];
                            item = ref_18_1.value;
                        ...
                        case 7:
                            try {
                                if (ref_18_1 && !ref_18_1.done && (_a = ref_18.return)) _a.call(ref_18);
                            }
